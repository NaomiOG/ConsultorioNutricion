	    				...
	    				buttons: {
        						confirmar:{
        						 ...
        						 action: function () {
            							...
            							type:"POST",
            							method:"POST",
            							url: "proceso-medicamento.php?id="+id+"&accion=medicamento.delete", 
  										});
  										$(location).attr('href',"medicamento.php?id="+id+"&accion=medicamento.delete");
  			 ...
  			 $(document).ready(function(){   
	  			 function ajaxBuscador(){
			          ...
			          $.ajax({
			                type:"POST",
			                method:"POST",
			                url: "proceso-medicamento.php?accion=medicamento.filtro", 
			                data: parametros,
