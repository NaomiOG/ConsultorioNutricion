  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div style="display: inline-flex;">
     <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="paciente.php" style="color: #11525D; ">Pacientes</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="empleados.php?E=4" style="color: #11525D; ">Empleados</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="medicamento.php" style="color: #11525D; ">Medicamento</a></li>
       <li class="nav-item">
            <a class="nav-link" href="tipoCita.php?E=4" style="color: #11525D; ">Tipos de citas</a></li>
      <li class="nav-item">
        <a class="nav-link" href="cita.php" style="color: #11525D; ">Citas</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../login.php" style="color: #11525D; "><img id="salir" src="../imagenes/img_trans.png"/>Cerrar sesión</a>
      </li>
    </ul>
    <div class="form-inline my-2 my-lg-0" style="margin-left: 300px;">
