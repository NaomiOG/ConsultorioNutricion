		...
		function formDieta($id,$pid){
				...
				$result.='
					...
					<form method="post" id="datosExpediente">
					    ...
					    <br/>
					        ...
					        <textarea class="form-control" id="indicaciones" name="indicaciones" cols="100" rows="5"></textarea>
					    ...
					    $result.=(isset($row->medida)?'<input id="modificarExp" type="button" style=" margin-left:50px; width:100px;" class="btn btn-sm- btn-primary" value="Actualizar">&nbsp&nbsp<input id="volver" type="button" style="style="margin-left:100px; width:100px;" class="btn btn-sm- btn-primary" value="Regresar"></div>':'<input id="insertarExp" type="button" style="margin-left:660px;" class="btn btn-sm- btn-primary" value="Registrar">');
			...
			function formCitaEdit($id,$pid){
				...
				$result.='
					...
					$result.='</form>
					</div></div></div><br/><div style="display:inline-flex; text-align:center; margin-left:48%">
					    <input id="modificar" type="button" style="margin-left:0px; width:100px;" class="btn btn-sm- btn-primary" value="Actualizar"/></div>';
					return $result;
			}
