...
class baseDatos
{
	...
	function inicializa($serv="localhost",$user="root",$puser="",$bd="nutricion"){ #Todo elemento de información dentro de un método es LOCAL (Pertenece AL MÉTODO). Por ello debe usarse this, para indicar que se hace referencia a un atributo DE LA CLASE 
